function loadHomepageFeatured(){
    ...
    //mobile featured
    document.getElementById("featuredPostCardM").onclick = function () { location.href='./loader.html?post=' + featuredLower };
    setElmtThumbnail("featuredPostImgM", "./posts/" + featuredLower + "/thumbnail.jpg");
